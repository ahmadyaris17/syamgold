...
export default function Footer({ companyInfo, outlets }) {
  ...
  return (
    <footer id="kontak" className="relative overflow-hidden">
      ...
      {/* Main footer */}
      <div className="bg-dark-900 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            {/* Brand */}
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary-600 to-gold-400 flex items-center justify-center shadow-lg shadow-primary-600/30">
                  <span className="text-white font-display font-bold">SG</span>
                </div>
                <div>
                  <div className="text-white font-display font-bold text-xl">SYAM GOLD</div>
                  <div className="text-primary-400 text-sm">PT. Rahmat Indo Mulia</div>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                <a
                  href={companyInfo?.whatsapp ? `https://wa.me/${companyInfo.whatsapp}` : '#'}
                  target="_blank"
