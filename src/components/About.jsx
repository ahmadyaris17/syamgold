...
const FEATURES = [
  {
    ...
    desc: 'Sudah berpengalaman lebih dari 10 tahun. Proses penilaian emas transparan dan jujur.',
  ...
  },
  {
    icon: Zap,
    title: 'Proses Cepat',
    desc: 'Penilaian dan pembayaran dilakukan langsung di tempat, tanpa antri lama.',
    color: 'from-gold-400/20 to-gold-500/10',
  ...
  },
  {
    icon: Eye,
    title: 'Transparan',
    desc: 'Penimbangan dilakukan di depan Anda dengan timbangan terverifikasi.',
  ...
  },
  {
    icon: Award,
    title: 'Harga Terbaik',
    desc: 'Kami memberikan harga terbaik di pasaran, selalu update mengikuti harga dunia.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-warm border border-primary-600/30 mb-4">
            ...
            <span className="text-gold-400 text-sm font-semibold tracking-wider">MENGAPA KAMI</span>
          </div>
          ...
          {FEATURES.map((feat, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative p-6 rounded-3xl bg-gradient-to-br ${feat.color} border ${feat.border} card-hover group overflow-hidden`}
              >
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <div className="glass-warm border border-primary-600/20 rounded-3xl p-8 text-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary-600 to-gold-400 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-primary-600/40 animate-float">
                <span className="font-display font-bold text-3xl text-white">SG</span>
              </div>
              <h4 className="font-display text-2xl font-bold text-white mb-2">Syam Gold</h4>
              <p className="text-primary-400 font-medium mb-4">PT. Rahmat Indo Mulia</p>
              ...
              <div className="mt-4 text-gold-400 font-bold">— Tim Syam Gold</div>
            </div>
          </motion.div>
        </div>
      </div>
